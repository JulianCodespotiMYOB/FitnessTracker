        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<int>(type: "integer", nullable: false),
                    MainMuscleGroup = table.Column<int>(type: "integer", nullable: false),
                    DetailedMuscleGroup = table.Column<int>(type: "integer", nullable: true),
                    OtherMuscleGroups = table.Column<int[]>(type: "integer[]", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeeklyWorkoutAmountGoal = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkoutBuddy", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkoutBuddy_Users_Id",
                        column: x => x.Id,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
